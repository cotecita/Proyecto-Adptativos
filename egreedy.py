...
if __name__ ==  "__main__":
    ...
    if len(sys.argv) == 5:
        ...
        determinismo = float(sys.argv[3])
        size_lista = int(sys.argv[4])
    else:
        print("el modo correcto de ejecución es: python3 egreedy.py -i <instancia-problema> <nivel-determinismo> <tamaño-lista-mejores>")
        sys.exit()
